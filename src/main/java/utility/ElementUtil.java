...
//		}
	...
	public String waitForTitleIsDisplayed(String titleValue, int timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
		try {
	...
	/* This method returns current date time to append with any string
	 * 
	 * @return string value
	 */
	    public String getLocalDateTime() {
			...
			String format=ldt.format(myFormat);
			return format;
	    }
